<h1 align="center">
  <a href="https://standardjs.com"><img src="assets/octocode.png" alt="GitLeet - Automatically sync your code to GitHub." width="400"></a>
  <br>
  <a href="https://chrome.google.com/webstore/detail/leethub/aciombdipochlnkbpcbgdpjffcfdbggi">GitLeet</a> - Automatically sync your code to GitHub.
  <br>
  <br>
</h1>

<p align="center">
  <a href="https://github.com/QasimWani/GitLeet/blob/main/LICENSE">
  ...
  <a href="https://github.com/QasimWani/GitLeet/graphs/contributors" alt="Contributors">
    <img src="https://img.shields.io/github/contributors/QasimWani/GitLeet" />
  </a>
  <a href="https://twitter.com/intent/tweet?text=GitLeet%20-%20Automatically%20sync%20your%20code%20to%20GitHub%20after%20solving%20any%20leetcode%20problems!&url=https://github.com/QasimWani/GitLeet&hashtags=javascript,github,leetcode,coding,interview,chrome">
...
<div align="center">
  <a href="https://www.producthunt.com/posts/leethub?utm_source=badge-featured&utm_medium=badge&utm_souce=badge-leethub" target="_blank">
    <img src="https://api.producthunt.com/widgets/embed-image/v1/featured.svg?post_id=275757&theme=light" alt="GitLeet - Automatically sync your code b/w Leetcode & GitHub. | Product Hunt" />
  </a>
...
## GitLeet progress and numbers (YouTube Video):
[![GitLeet](https://user-images.githubusercontent.com/43754306/165053510-a757c95e-c3bc-49d5-995c-7a52368abd37.png)](https://www.youtube.com/watch?v=o33PIjqlOgw "GitLeet saves lives!")
...
As of now, GitHub is developers' #1 portfolio. GitLeet just makes it much easier (autonomous) to keep track of progress and contributions on the largest network of engineering community, GitHub.</p>
...
## How does GitLeet work?     

<h4> Your GitLeet portfolio could look like <a href="https://github.com/tanyarajhans/LeetCode"> this</a>!  </h4>
<p>It's as simple as:</p>
<ol>
  <li>After installation, launch GitLeet.</li>
  <li>Click on "authorize with GitHub" button to automatically set up your account with GitLeet.</li>
  <li>Setup an existing/new repository with GitLeet (private by default) by clicking "Get Started" button.</li>
...
And that's what GitLeet is supposed to do: indirectly improving your coding skills while improving your portfolio to ACE that interview at <em>insert_name_here</em>!
</p>
...
# How to set up GitLeet for local development?
...
<ol>
  ...
  <li>Select the entire GitLeet folder</li>
